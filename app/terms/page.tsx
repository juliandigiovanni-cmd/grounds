      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-grounds-brown">
          <section>
            ...
            <p>By using Grounds, you agree to these terms. If you disagree, please stop using the service.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 mt-2">
              <li>Grant Grounds a perpetual, royalty-free license to display and distribute your submission</li>
          ...
          <section>
            ...
            <p>Grounds makes no warranty that cafe information (hours, addresses, quality scores) is accurate, complete, or current. Coffee shops open, close, and change — always verify before traveling. We are not liable for any loss arising from reliance on our data.</p>
          </section>
          ...
          <section>
            ...
            <p>If you believe content on Grounds infringes your copyright, contact us at dmca@grounds.coffee with a description of the content and your ownership claim. We will respond within 10 business days.</p>
          </section>

          <section>
            <h2 className="font-serif text-2xl font-bold text-grounds-espresso mb-3">6. Limitation of Liability</h2>
            <p>To the maximum extent permitted by law, Grounds is not liable for any indirect, incidental, or consequential damages arising from use of this service.</p>
          </section>

          <section>
            <h2 className="font-serif text-2xl font-bold text-grounds-espresso mb-3">7. Changes</h2>
            <p>We may update these terms. Continued use of Grounds after changes constitutes acceptance of the new terms.</p>
          </section>
        </div>
      </div>
    </div>
