    ...
    <div className="relative inline-flex items-center gap-1">
      ...
      {showTooltip && tooltipVisible && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 bg-grounds-espresso text-grounds-cream text-xs rounded-lg p-3 shadow-xl z-50">
          ...
          <p className="opacity-80 leading-relaxed">Our curation signal: named roaster (25pts), filter brew methods (20pts), independent (20pts), press coverage (15pts), part of a roaster family (10pts), community upvotes (10pts).</p>
