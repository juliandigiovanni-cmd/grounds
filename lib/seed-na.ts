...
export const NA_RAW_CAFES: Omit<Cafe, 'id' | 'created_at' | 'third_wave_score' | 'overall_rating' | 'review_count' | 'permanently_closed'>[] = [
  ...
  {
    name: "Nobletree Coffee",
    slug: "nobletree-coffee-red-hook",
    lat: 40.6773, lng: -74.0131,
    city: "New York City", country: "United States",
    address: "45 Van Dyke St, Brooklyn, NY 11231",
    roaster: "Nobletree Coffee",
    brew_methods: ["pour-over", "espresso", "chemex", "cold-brew"],
    vibe_tags: ["roastery-on-site", "outdoor-seating"],
    instagram_handle: "nobletreecoffee",
    website: "https://nobletreecoffee.com/",
    editorial_blurb: "Farm-to-cup roastery in Red Hook — Nobletree owns a Costa Rican farm, and the provenance shows in every cup they serve.",
    featured_in: ["sprudge", "eater"],
