...
export const NA_RAW_CAFES: (Omit<Cafe, 'id' | 'created_at' | 'third_wave_score' | 'overall_rating' | 'review_count' | 'permanently_closed'> & { permanently_closed?: boolean })[] = [
  ...
  // MONTREAL
  {
    ...
    roaster: "Myriade Roasting Co.",
    roaster_family: true,
    brew_methods: ["espresso", "pour-over"],
    vibe_tags: ["laptop-friendly", "minimalist"],
    instagram_handle: "cafemyriade",
    website: "https://cafemyriade.com/",
    editorial_blurb: "The 2008 original near Concordia and Montreal's specialty standard-bearer — coffee from its own Myriade Roasting Co., rounded out by guest roasters like 49th Parallel and Traffic.",
    featured_in: ["sprudge", "timeout"],
  ...
  },
  {
    ...
    lat: 45.5170, lng: -73.5792,
    google_place_id: "ChIJ__8PNTMayUwRA4Ovujm_Oro",
    city: "Montreal", country: "Canada",
    address: "4021 Blvd Saint-Laurent, Montréal, QC H2W 1Y4",
    ...
    editorial_blurb: "Dispatch's Saint-Laurent café in the Plateau — the Montreal roaster that started out selling cold brew, now with a filter program serious enough to run Chemex and V60 workshops.",
    featured_in: ["sprudge", "timeout"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
    ...
    roaster: "Café Olimpico house blend",
  ...
  },
  {
    ...
    vibe_tags: ["outdoor-seating", "laptop-friendly"],
    instagram_handle: "cafeneve",
    website: "http://www.cafeneve.com/",
    editorial_blurb: "The Plateau original on Rachel since 2009 — Pilot espresso, guest roasts from the likes of Canal, and a long-standing pull for students and freelancers.",
    featured_in: ["timeout"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
    ...
    editorial_blurb: "The McGill-area favourite that moved from Avenue du Parc to Rue Clark by Place des Arts — rotating Canadian roasters like 49th Parallel and Monogram, with loft seating upstairs.",
    featured_in: ["sprudge", "timeout"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
    ...
    brew_methods: ["espresso", "pour-over"],
    vibe_tags: ["coworking", "laptop-friendly"],
  ...
  {
    name: "49th Parallel Coffee Roasters Old Montreal",
    slug: "49th-parallel-coffee-old-montreal",
    lat: 45.5008, lng: -73.5595,
    city: "Montreal", country: "Canada",
    address: "488 Rue McGill, Montréal, QC H2Y 2H2",
    ...
    editorial_blurb: "The Vancouver roaster's first café outside B.C., set in a circa-1910 heritage building on Rue McGill — 49th Parallel espresso alongside Lucky's doughnuts reworked with Quebec classics.",
    featured_in: ["timeout"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
    name: "Structure Roasters",
    slug: "structure-roasters-montreal",
    lat: 45.5006, lng: -73.5589,
    city: "Montreal", country: "Canada",
    address: "460 Rue McGill, Montréal, QC H2Y 2H2",
    roaster: "Structure Roasters",
    roaster_family: true,
    brew_methods: ["espresso", "pour-over"],
    vibe_tags: ["laptop-friendly"],
    instagram_handle: "structureroasters",
    website: "https://structurecoffeeroasters.com/",
    editorial_blurb: "A Montreal roaster first and café second — directly sourced coffee roasted by its own team, served in an industrial, mid-century space behind the glass doors of an Old Montreal greystone.",
    featured_in: ["sprudge"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
    name: "diff. (Café Différance)",
    slug: "diff-cafe-differance-montreal",
    lat: 45.5027, lng: -73.5628,
    city: "Montreal", country: "Canada",
    address: "449 Avenue Viger O, Montréal, QC H2Z 2B8",
    roaster: "Multiple guest roasters",
    brew_methods: ["espresso", "cold-brew"],
    vibe_tags: [],
    instagram_handle: "cafedifferance",
    editorial_blurb: "A small, light-filled espresso bar on Viger at the edge of Old Montreal — Phil & Sebastian and Bows & Arrows on rotation, Hof Kelsten pastries, and weekday hours built around the office crowd.",
    featured_in: ["timeout", "tastet"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
    name: "Le Firmament by Café Saint-Henri",
    slug: "le-firmament-cafe-saint-henri-montreal",
    lat: 45.5044, lng: -73.5560,
    city: "Montreal", country: "Canada",
    address: "110 Rue Notre-Dame O, Montréal, QC H2Y 1T1",
    roaster: "Café Saint-Henri",
    roaster_family: true,
    brew_methods: ["espresso"],
    vibe_tags: [],
    instagram_handle: "cafesainthenri",
    website: "https://www.sainthenri.ca/",
    editorial_blurb: "Café Saint-Henri's 28-square-metre café inside Notre-Dame Basilica, opened in 2026 — a blend made only for the site (maple, pecan, cocoa), church-pew seating, and part of the profits going to the basilica's restoration.",
    featured_in: ["tastet"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
    ...
    city: "Montreal", country: "Canada",
    address: "405 Rue Jarry E, Montréal, QC H2P 1V2",
    roaster: "Larue & Fils",
    roaster_family: true,
    brew_methods: ["espresso"],
    vibe_tags: [],
    ...
    editorial_blurb: "A small Villeray café group that has roasted its own coffee since 2019 — house blends like Principal and Placebo on espresso, with a neighbourhood crowd to match.",
    featured_in: ["timeout"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
    ...
    brew_methods: ["espresso"],
    vibe_tags: [],
    instagram_handle: "cafereplika",
    website: "https://www.cafereplika.com/",
    editorial_blurb: "A Plateau café run by Ceren Tunasat and Ozan Ucan since 2013 — De Mello espresso, Turkish coffee (mastic included), and homemade börek, simit and tahini cookies.",
    featured_in: ["tastet"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  ...
  // TORONTO
  {
    ...
    address: "439 Richmond St W, Toronto, ON M5V 1X9",
    roaster: "Pilot Coffee Roasters",
    roaster_family: true,
    brew_methods: ["espresso", "cold-brew"],
    vibe_tags: ["laptop-friendly", "outdoor-seating"],
    ...
    editorial_blurb: "Pilot's café on Richmond Street West — coffee from the Toronto roaster that opened in 2009, roasted at its own facility on Wagstaff Drive.",
  ...
  },
  {
    ...
    city: "Toronto", country: "Canada",
    address: "61 Spadina Ave, Toronto, ON M5V 0T9",
    ...
    editorial_blurb: "Neo's King and Spadina café — De Mello Palheta espresso, including an exclusive Neo blend, alongside a rotating guest-roaster program.",
    featured_in: [],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
  ...
  },
  {
    ...
    roaster: "Subtext Coffee Roasters",
    roaster_family: true,
    brew_methods: ["espresso", "pour-over", "french-press"],
    vibe_tags: ["outdoor-seating", "laptop-friendly"],
  ...
  },
  {
    ...
    featured_in: ["timeout", "perfect_daily_grind"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
    name: "Reunion Coffee Roasters",
    slug: "reunion-island-coffee-toronto",
    lat: 43.6506, lng: -79.4505,
    google_place_id: "ChIJmwVg0zU0K4gRzdG07rGdzzw",
    city: "Toronto", country: "Canada",
    address: "385 Roncesvalles Ave, Toronto, ON M6R 2N1",
    roaster: "Reunion Coffee Roasters",
    roaster_family: true,
    brew_methods: ["espresso", "pour-over"],
    vibe_tags: ["outdoor-seating", "laptop-friendly"],
    instagram_handle: "reunioncoffee",
    website: "https://reunioncoffeeroasters.com/",
    editorial_blurb: "Roncesvalles Village's specialty flagship from Reunion Coffee Roasters — its direct-trade farmer relationships show up in every pour.",
    featured_in: ["sprudge"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
  ...
  },
  {
    ...
    brew_methods: ["espresso", "cold-brew"],
    vibe_tags: ["minimalist", "laptop-friendly"],
    instagram_handle: "demellocoffee",
  ...
  // MONTREAL (additional 5)
  {
    ...
    editorial_blurb: "Facing McGill's gates on Sherbrooke since 2013 — the café that started on Intelligentsia has grown into its own roaster, with pour-over alongside the espresso bar.",
    featured_in: ["sprudge", "timeout"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  ...
  // TORONTO (additional 5)
  {
    ...
    city: "Toronto", country: "Canada",
    address: "1 Adelaide St E, Toronto, ON M5C 1J4",
    roaster: "Hale Coffee",
    roaster_family: true,
    brew_methods: ["espresso", "pour-over"],
    vibe_tags: ["laptop-friendly", "minimalist"],
    ...
    editorial_blurb: "Hale Coffee Company's café at Yonge and Adelaide — coffee roasted at Hale's own roastery in the Junction.",
    featured_in: [],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  ...
  // TORONTO (additional — targeting 32 total)
  {
    ...
    brew_methods: ["espresso", "pour-over", "aeropress"],
    vibe_tags: ["laptop-friendly", "minimalist"],
    instagram_handle: "fahrenheitto",
    website: "http://www.fahrenheitcoffee.com/",
    editorial_blurb: "Fahrenheit Coffee on Lombard Street — espresso, pour-over and AeroPress built on a rotating line-up of Ontario roasters such as Pilot.",
    featured_in: [],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  {
    ...
    city: "Toronto", country: "Canada",
    address: "1 Trinity St, Toronto, ON M5A 3C4",
  ...
  },
  {
    ...
    editorial_blurb: "Queen West café known for skipping wifi to keep conversation front and centre — espresso built on beans from Detour Coffee Roasters.",
    featured_in: ["sprudge"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
  ...
  // MONTREAL (additional — targeting 26 total)
  {
    ...
    vibe_tags: ["laptop-friendly"],
    website: "https://cafemyriade.com/",
    editorial_blurb: "Café Myriade's Westmount location on Avenue Victoria — the house Myriade Roasting Co. coffee plus guest roasters, served with the same precision as the downtown original.",
    featured_in: ["timeout"],
    verified: true, last_verified_at: "2026-09-12", verification_source: "admin",
  },
