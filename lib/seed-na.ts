...
export const NA_RAW_CAFES: (Omit<Cafe, 'id' | 'created_at' | 'third_wave_score' | 'overall_rating' | 'review_count' | 'permanently_closed'> & { permanently_closed?: boolean })[] = [
  ...
  },
  {
    ...
    brew_methods: ["pour-over", "espresso", "cold-brew"],
    vibe_tags: ["outdoor-seating", "laptop-friendly"],
    editorial_blurb: "GGET's Los Feliz café on the edge of Atwater Village brings the city's finest specialty roasting program to the eastern urban corridor.",
    featured_in: ["sprudge"],
    verified: true, last_verified_at: "2025-10-01", verification_source: "admin",
  },
  {
  ...
  {
    name: "Render Coffee",
    slug: "render-coffee-boston",
    lat: 42.3395, lng: -71.0820,
    city: "Boston", country: "United States",
    address: "563 Columbus Ave, Boston, MA 02118",
    roaster: "Render Coffee",
    brew_methods: ["pour-over", "espresso", "cold-brew"],
    vibe_tags: ["laptop-friendly", "outdoor-seating"],
    instagram_handle: "rendercoffee",
    website: "https://www.rendercoffee.com/",
    editorial_blurb: "South End's neighborhood roastery — Render sources responsibly, roasts precisely, and has made Columbus Ave one of Boston's best café blocks.",
    featured_in: ["sprudge", "infatuation"],
    verified: true, last_verified_at: "2025-10-01", verification_source: "admin",
  },
  {
  ...
  },
  {
    ...
    slug: "broadsheet-coffee-boston",
    lat: 42.3569, lng: -71.0632,
    city: "Boston", country: "United States",
    address: "7 Hamilton Pl, Boston, MA 02108",
    roaster: "Broadsheet Coffee Roasters",
    brew_methods: ["pour-over", "espresso", "chemex", "cold-brew"],
    vibe_tags: ["minimalist", "laptop-friendly"],
    instagram_handle: "broadsheetcoffee",
    website: "https://www.broadsheetcoffee.com/",
    editorial_blurb: "Cambridge's most admired roastery in a downtown Boston bar — Broadsheet's sourcing relationships with East African farms produce some of the most complex cups in New England.",
    featured_in: ["sprudge", "standart"],
    verified: true, last_verified_at: "2025-10-01", verification_source: "admin",
  },
  {
  ...
  {
    name: "Qualia Coffee",
    slug: "qualia-coffee-dc",
    lat: 38.9480, lng: -77.0228,
    city: "Washington DC", country: "United States",
    address: "3917 Georgia Ave NW, Washington, DC 20011",
    roaster: "Qualia Coffee",
    brew_methods: ["pour-over", "espresso", "aeropress"],
    vibe_tags: ["laptop-friendly", "minimalist"],
    instagram_handle: "qualiacoffeedc",
    website: "https://www.qualiacoffee.com/",
    editorial_blurb: "Petworth's specialty anchor — Qualia is DC's most forward-thinking roastery, sourcing from small farms with direct relationships and serving the neighbourhood well above its pay grade.",
    featured_in: ["sprudge"],
    verified: true, last_verified_at: "2025-10-10", verification_source: "admin",
  },
  {
  ...
  },
  {
    ...
    lat: 29.9328, lng: -90.1005,
    city: "New Orleans", country: "United States",
    address: "3112 Magazine St, New Orleans, LA 70115",
    roaster: "Congregation Coffee",
    brew_methods: ["pour-over", "espresso", "aeropress"],
    vibe_tags: ["laptop-friendly", "minimalist"],
    instagram_handle: "congregationcoffee",
    website: "https://www.congregationcoffee.com/",
    editorial_blurb: "Magazine Street's most focused specialty bar — Congregation sources with care and serves with conviction, a welcome counterpoint to the city's more traditional café culture.",
    featured_in: ["sprudge"],
    verified: true, last_verified_at: "2025-10-08", verification_source: "admin",
  },
  {
    name: "Merchant New Orleans",
    slug: "merchant-new-orleans",
    lat: 29.9524, lng: -90.0710,
    city: "New Orleans", country: "United States",
    address: "800 Common St, New Orleans, LA 70112",
    brew_methods: ["espresso", "pour-over", "cold-brew"],
    vibe_tags: ["minimalist", "laptop-friendly"],
    instagram_handle: "merchantnola",
    website: "https://www.merchantnola.com/",
    editorial_blurb: "CBD's slick specialty café — Merchant brings a polished third-wave sensibility to the downtown business district and has quickly become the go-to for anyone who takes their morning coffee seriously.",
  ...
  // MINNEAPOLIS
  {
    ...
    editorial_blurb: "South Minneapolis' anchor roastery — Dogwood has been building one of the Midwest's most rigorous specialty programs for over a decade and the Nicollet Ave café is the best place to taste why.",
    featured_in: ["sprudge", "standart"],
    verified: true, last_verified_at: "2025-10-12", verification_source: "admin",
  },
  {
  ...
  {
    name: "Penny's Coffee",
    slug: "pennys-coffee-minneapolis",
    lat: 44.9826, lng: -93.2710,
    city: "Minneapolis", country: "United States",
    address: "530 N 4th St, Minneapolis, MN 55401",
    brew_methods: ["espresso", "pour-over", "cold-brew"],
    vibe_tags: ["laptop-friendly", "minimalist"],
    instagram_handle: "pennyscoffee",
    website: "https://www.pennyscoffee.com/",
    editorial_blurb: "North Loop's sleek specialty anchor — Penny's brings a polished café sensibility to one of Minneapolis' fastest-growing neighbourhoods and serves it with the kind of precision the space deserves.",
    featured_in: ["sprudge", "infatuation"],
    verified: true, last_verified_at: "2025-10-12", verification_source: "admin",
  },
];
