...
export const NA_RAW_CAFES: Omit<Cafe, 'id' | 'created_at' | 'third_wave_score' | 'overall_rating' | 'review_count' | 'permanently_closed'>[] = [
  ...
  },
  {
    ...
    lat: 34.1278, lng: -118.0910,
    city: "Los Angeles", country: "United States",
    address: "3007 Huntington Dr, Pasadena, CA 91107",
    roaster: "Klatch Coffee",
    brew_methods: ["pour-over", "espresso", "chemex", "cold-brew"],
    vibe_tags: ["roastery-on-site", "laptop-friendly"],
    editorial_blurb: "Award-winning Southern California roastery with a national competition record — the Pasadena café brings championship-level pour-overs and a world-class cupping program to the east side of the city.",
    featured_in: ["sprudge"],
    verified: true, last_verified_at: "2025-10-01", verification_source: "admin",
  },
  {
