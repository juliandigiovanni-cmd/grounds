...
export const OCEANIA_RAW_CAFES: Omit<Cafe, 'id' | 'created_at' | 'third_wave_score' | 'overall_rating' | 'review_count' | 'permanently_closed'>[] = [
  ...
  {
    name: "Pressed & Fresh",
    slug: "pressed-and-fresh-prahran",
    lat: -37.8491, lng: 144.9850,
    city: "Melbourne", country: "Australia",
    address: "178 High St, Prahran VIC 3181",
    roaster: "Multiple guest roasters",
    brew_methods: ["espresso", "pour-over", "cold-brew"],
    vibe_tags: ["outdoor-seating", "laptop-friendly"],
    instagram_handle: "pressedandfresh",
    editorial_blurb: "High Street Prahran café where the juice programme and the rotating specialty roster coexist without competition — the neighbourhood all-day café Melbourne south does best.",
    featured_in: ["timeout"],
    verified: false, last_verified_at: "2025-09-01", verification_source: "community",
  },
  {
  ...
  {
    name: "Boatbuilders Yard",
    slug: "boatbuilders-yard-south-wharf",
    lat: -37.8233, lng: 144.9515,
    city: "Melbourne", country: "Australia",
    address: "23 South Wharf Promenade, South Wharf VIC 3006",
    roaster: "St Ali",
    brew_methods: ["espresso", "pour-over", "cold-brew"],
    vibe_tags: ["outdoor-seating", "dog-friendly"],
    instagram_handle: "boatbuildersyard",
    editorial_blurb: "Docklands waterfront café pouring St Ali on the Yarra River promenade — Melbourne at its most scenic, the espresso at its most consistent, and the morning crowd arriving by bicycle.",
    featured_in: ["eater", "timeout"],
    verified: true, last_verified_at: "2025-10-01", verification_source: "admin",
  },
  {
  ...
  },
  {
    ...
    slug: "surry-hills-coffee-collective",
    lat: -33.8939, lng: 151.2095,
    city: "Sydney", country: "Australia",
    address: "182 Campbell St, Surry Hills NSW 2010",
    roaster: "Multiple guest roasters",
    brew_methods: ["espresso", "pour-over", "aeropress"],
    vibe_tags: ["minimalist", "laptop-friendly"],
    instagram_handle: "surryhillscoffee",
    editorial_blurb: "Campbell Street specialty collective running a rigorously curated Australasian roaster rotation — the kind of neighbourhood bar that raises the street's average considerably.",
    featured_in: ["sprudge"],
    verified: false, last_verified_at: "2025-09-01", verification_source: "community",
  },
  {
