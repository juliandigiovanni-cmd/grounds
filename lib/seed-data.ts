...
export const SEED_CITIES = [
  ...
  { id: 'city-4', name: 'New York City', country: 'United States', lat: 40.7128, lng: -74.0060, slug: 'new-york-city', cafe_count: 28, city_blurb: 'New York\'s specialty coffee scene is borough-by-borough diverse — Brooklyn leads on craft, Manhattan on volume, and the competition makes everyone better.' },
  ...
  { id: 'city-6', name: 'Montreal', country: 'Canada', lat: 45.5017, lng: -73.5673, slug: 'montreal', cafe_count: 16, city_blurb: 'Montreal\'s bilingual café culture and Québécois identity produce some of North America\'s most distinctive specialty shops.' },
  ...
  { id: 'city-12', name: 'Portland', country: 'United States', lat: 45.5051, lng: -122.6750, slug: 'portland', cafe_count: 20, city_blurb: 'Portland\'s coffee heritage runs deep — this is where the American third wave started, and the roasting culture it built still sets global standards.' },
  { id: 'city-13', name: 'San Francisco', country: 'United States', lat: 37.7749, lng: -122.4194, slug: 'san-francisco', cafe_count: 21, city_blurb: 'San Francisco\'s specialty scene is as opinionated as the city itself — SOMA roasteries and Mission standing bars set the West Coast benchmark.' },
  { id: 'city-14', name: 'Chicago', country: 'United States', lat: 41.8781, lng: -87.6298, slug: 'chicago', cafe_count: 21, city_blurb: 'Chicago\'s third-wave story starts with Intelligentsia and keeps getting better — the West Loop and Wicker Park are now among America\'s most exciting coffee corridors.' },
  ...
  { id: 'city-29', name: 'Toronto', country: 'Canada', lat: 43.6532, lng: -79.3832, slug: 'toronto', cafe_count: 18, city_blurb: 'Toronto\'s specialty coffee scene has quietly become one of North America\'s most sophisticated — Pilot, Sam James, and a generation of independent roasters have built something world-class.' },
  { id: 'city-30', name: 'Vancouver', country: 'Canada', lat: 49.2827, lng: -123.1207, slug: 'vancouver', cafe_count: 18, city_blurb: 'Vancouver\'s Gastown and Mount Pleasant are home to some of Canada\'s finest roasters — Revolver, 49th Parallel, and Matchstick have made this a mandatory stop for serious coffee travelers.' },
  { id: 'city-31', name: 'Miami', country: 'United States', lat: 25.7617, lng: -80.1918, slug: 'miami', cafe_count: 12, city_blurb: 'Miami\'s specialty coffee scene is anchored by Panther Coffee\'s Wynwood roastery and growing fast — the Cuban coffee heritage and the new wave of third-wave cafés make an irresistible combination.' },
  ...
  { id: 'city-36', name: 'Seattle', country: 'United States', lat: 47.6062, lng: -122.3321, slug: 'seattle', cafe_count: 14, city_blurb: 'Seattle\'s coffee culture runs deeper than any other American city — from Victrola\'s Capitol Hill roastery to Slate\'s no-frills Fremont standing bar, the Pacific Northwest has been setting its own specialty standard for decades.' },
  { id: 'city-37', name: 'Austin', country: 'United States', lat: 30.2672, lng: -97.7431, slug: 'austin', cafe_count: 8, city_blurb: 'Austin\'s specialty coffee scene has grown as fast as the city itself — from Cuvée\'s East Austin roastery to Houndstooth\'s downtown precision bar, the Texas capital is now a genuine specialty destination.' },
  { id: 'city-38', name: 'Denver', country: 'United States', lat: 39.7392, lng: -104.9903, slug: 'denver', cafe_count: 8, city_blurb: 'Denver\'s high-altitude roasting scene is as distinctive as the city\'s geography — Corvus and Novo roast at 5,280 feet and the thinner air produces a flavor clarity that roasters elsewhere can only envy.' },
];
