...
const RAW_CITIES = [
  ...
  { id: 'city-39', name: 'Boston',          country: 'United States', lat: 42.3601,  lng: -71.0589,  slug: 'boston',          city_blurb: 'George Howell basically invented single-origin coffee in America, and Boston\'s specialty scene has never looked back — Gracenote and Ogawa keep the standard high.' },
  ...
  { id: 'city-51', name: 'Bengaluru',       country: 'India',         lat: 12.9716,  lng: 77.5946,   slug: 'bengaluru',       city_blurb: 'Bengaluru is India\'s specialty coffee capital — Chikmagalur and Coorg\'s estates sit just a few hours up the road, and the city has parlayed that proximity into a genuine third-wave scene, from farm-owning roasters running their own cafés to homegrown chains that reshaped how the country drinks its coffee.' },
  { id: 'city-52', name: 'Mumbai',          country: 'India',         lat: 19.0760,  lng: 72.8777,   slug: 'mumbai',          city_blurb: 'Mumbai\'s coffee scene runs on tropical-latitude tenacity — direct-trade roasters coax delicate florals out of Chikmagalur and Kodaikanal beans in un-air-conditioned Bandra bungalows, turning South Indian filter coffee\'s homeland into one of Asia\'s most ambitious pour-over cities.' },
  { id: 'city-53', name: 'New Delhi',       country: 'India',         lat: 28.6139,  lng: 77.2090,   slug: 'new-delhi',       city_blurb: 'Delhi\'s coffee scene has leapt from filter-coffee heritage shops to a genuine third-wave movement in under a decade — roasters here now source directly from Karnataka, Tamil Nadu, and the Northeast, treating Indian-grown beans with the same rigor once reserved for Ethiopian or Colombian lots.' },
];
